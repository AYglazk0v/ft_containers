...
int main(int argc, char** argv) {
	...
	std::cout << "1 element: " << second_map_int[1] << "; ";
	std::cout << "55 element: " << second_map_int[55] << "; ";
	std::cout << "555 element: " << second_map_int[555] << "; " << std::endl;

	ft::map<int, int>::iterator mit = map_int.begin();
	ft::map<int, int>::iterator mit2 = second_map_int.begin();
	...
	// std::cout << "	find(5555) element :" << mit->first_ << " " << mit->second_ << std::endl;

	// std::cout << "count of 123 elements :" << map_int.count(123) << std::endl;
